...
class GooglePlayAPI(object):
    ...
    def __init__(self, androidId, lang=None, debug=False): # you must use a device-associated androidId value
        self.preFetch = {}
        if lang == None:
            lang = "zh_CN"
    ...
    def bulkDetails(self, packageNames):
        ...
        path = "bulkDetails"
        req = _googleplay_pb2.BulkDetailsRequest()
    ...
    def download(self, packageName, versionCode, offerType, apkfile):
